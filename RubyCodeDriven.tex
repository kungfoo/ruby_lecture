...
Ein Block in Ruby eigentlich immer zusammen mit einer Methode verwendet. Damit kann man zum Beispiel Funktionen die über Elemente iterieren Code mitgeben, der dann für jedes Element ausgeführt wird. Das sieht dann zum Beispiel so aus:
