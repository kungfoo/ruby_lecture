...
Dieser Kontext ist nun optimalerweise innerhalb der Jukebox (die Zeilen nach dem Kommetar), dann können wir direkt die Methoden \texttt{Jukebox\#start} und \texttt{Jukebox\#stop} verwenden um auf den Callback zu reagieren.
