...
\section{Connect to RESTful WS} % (fold)
\label{sec:connect_to_restful_ws}
TODO: Write
% section connect_to_restful_ws (end)
...
\section{Marshalling mit YAML} % (fold)
\label{sec:marshalling_mit_yaml}
TODO: Write
% section marshalling_mit_yaml (end)
