...
Dieser Kontext ist nun optimalerweise innerhalb der Jukebox (im Code nicht ausformuliert), dann können wir direkt die Methoden \texttt{Jukebox\#start} und \texttt{Jukebox\#stop} verwenden um auf den Callback zu reagieren.
